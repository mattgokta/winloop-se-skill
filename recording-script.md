...
**[Point at Technical Win Forecast Date]**

> "Technical Win Forecast Date: INPUT REQUIRED. Carlos said 'probably
...
**[Point at SE Notes block]**

> "SE Notes — 150 words. Decision-focused. No meeting recap, no feature
...
**[Point at POC Required]**

> "POC Required: No. With the reason: the architecture session resolves
...
> page in Portuguese. Forty-five test cases covering all four modes and
> all four statuses. Including adversarial cases — inputs designed to
> trick it into declaring a false win. It didn't."
...
Cut in this order:
1. Shorten the Salesforce walk — skip POC Required, just show SE Notes and Forecast Date
