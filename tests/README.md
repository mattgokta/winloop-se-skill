...
| 04 | Bounded POC is the right rung | Debrief | Validation required | The one legitimate `POC Required: Yes`: all bounded-POC conditions (proposition, criteria, owners, scope, exit decision) verified before the enum flips |
