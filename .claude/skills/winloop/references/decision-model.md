...
When a workshop can answer the question:

```text
POC Required: No
Reason: The remaining criteria can be evaluated through a bounded workshop using agreed labs and pass/fail criteria.
```
